...
public class ConfigClientApplication extends ConfigDynamicObject implements ClientApplication {
	/**
	 * Konstruktor eines System-Objekts für eine Applikation.
	 *
	 * @param configurationArea Konfigurationsbereich dieses System-Objekts
	 * @param systemObjectInfo  das korrespondierende Objekt aus den Konfigurationsdateien
	 */
	public ConfigClientApplication(ConfigurationArea configurationArea, SystemObjectInformationInterface systemObjectInfo) {
