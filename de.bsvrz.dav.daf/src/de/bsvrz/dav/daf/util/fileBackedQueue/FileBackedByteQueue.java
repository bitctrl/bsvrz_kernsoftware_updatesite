 ...
 * @version $Revision$
 */
public final class FileBackedByteQueue extends FileBackedQueue<Byte> {
	 ...
	 */
	public FileBackedByteQueue(final int memoryCapacity, final long filesystemCapacity) {
		super(memoryCapacity, filesystemCapacity, new ByteQueueSerializer());
	}
}
