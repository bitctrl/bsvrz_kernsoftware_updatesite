...
/**
 * Verhandlung der Verbindungsparameter (Client). Die Verbindungsparameter zwischen den beiden Datenverteilern (Timeout-Zeiten) werden verhandelt. Dabei werden
 * Standardparameter oder die Aufrufparameter vom Datenverteiler, der die Verbindung einleitet, als Vorschläge an den Kommunikationspartner übertragen. Dieser
 * trifft eine Festlegung der Parameter.
 *
 * @author Kappich Systemberatung
 * @version $Revision$
 */
public class TransmitterComParametersRequest extends DataTelegram {
	...
	public TransmitterComParametersRequest() {
		type = TRANSMITTER_COM_PARAMETER_REQUEST_TYPE;
