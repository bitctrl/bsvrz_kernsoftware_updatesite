...
public class IncreaseDeleteTime implements ArchiveQueryResult {
	 ...
	 * @param requiredData             Daten, die Länger im direkten Zugriff des Archivs bleiben sollen
	 * @param timePeriod               Zeitspanne, die die Daten länger im direkten Zugriff des Archivsystems bleiben
	 *                                 sollen
	 * @param streamedArchiveRequester Objekt, über das Daten verschickten kann
	 */
	...
	public void archiveResponse(Data data) {
		synchronized (this) {
			// aus den Daten das byte-Array anfordern. In dem Array sind die Informationen, ob der Auftrag zum verschieben des Löschzeitpunkts geklappt hat,
			// kodiert.
	...
	public void increaseDeleteTime() {
		...
		try {
			...
			// Zeitspanne um die die Zeitbereiche länger im Archiv verbleiben sollen
