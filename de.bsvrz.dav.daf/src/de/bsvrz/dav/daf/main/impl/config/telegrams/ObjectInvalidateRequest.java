...
/**
 * Diese Klasse stellt ein Anfragetelegramm zur Ungültigkeitserklärung dar. Durch dieses Telegramm wird ein Objekt ungültig erklärt.
 *
 * @author Kappich Systemberatung
 * @version $Revision$
 */
public class ObjectInvalidateRequest extends ConfigTelegram {
	...
	public ObjectInvalidateRequest() {
		_type = OBJECT_INVALIDATE_REQUEST_TYPE;
	}
	 ...
	 */
	public ObjectInvalidateRequest(long _configTime, long _objectId) {
		_type = OBJECT_INVALIDATE_REQUEST_TYPE;
	...
	public final String parseToString() {
		String str = "Objektinvalidation Anfrage: \n";
