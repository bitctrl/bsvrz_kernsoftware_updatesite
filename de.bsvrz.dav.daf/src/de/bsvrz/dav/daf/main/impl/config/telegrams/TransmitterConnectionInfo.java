...
public class TransmitterConnectionInfo {
	...
	/** Erzeugt ein neues Objekt, dessen Eigenschaften anschlieﬂend mit der read-Methode eingelesen werden sollten. */
	...
	/**
	 * Diese Methode wir f¸r automtisierte Tests benˆtigt.
	 *
