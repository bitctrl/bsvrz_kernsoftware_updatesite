...
public class MessageTemplate {
	 ...
	 * @param text Textbestandteile, die verkettet werden. Zur Erzeugung der einzelnen {@link OperatingMessageParam}-
	 *             Instanzen können die Statischen Methoen in dieser klasse benutzt werden.   
	 */
	 ...
	 * @param joiner  Verbinder zwischen dem zweitletzen un dem letzen Eintrag. Sinnvoll sind z. B. ", ", " und ", " sowie ", ...
	...
	/**
	 * Erstellt einen neuen Platzhalter für die der Meldung zugeordneten Kennungen (nicht identisch mit der Meldungs-ID,
	...
	public OperatingMessage newMessage(final SystemObject systemObject) {
		return new OperatingMessage(this, systemObject);
	}
	...
	public abstract static class OperatingMessageParam {
		 ...
		 * @param message Konkretes Betriebsmeldungs-Objekt als Quelle von gesetzten Variablen und ähnlichem
		 * @return true wenn alle evtl. benötigen Variablen definiert sind und dadurch ein Text mit {@link #format(OperatingMessage)}
		 * erzeugt werden kann
		 */
